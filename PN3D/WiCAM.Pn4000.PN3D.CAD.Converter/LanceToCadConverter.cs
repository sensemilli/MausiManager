...
public class LanceToCadConverter : MacroToCadConverterBase
{
	private const int ToolType = 52;

	public static bool AddCadGeoElements(Lance lance, global::WiCAM.Pn4000.BendModel.Base.Matrix4d worldMatrix, Cad2DDatabase db2D, IConfigProvider configProvider)
	{
		Macro3DConfig macro3DConfig = configProvider.InjectOrCreate<Macro3DConfig>();
		double size = lance.Size0;
		double size2 = lance.Size1;
		double size3 = lance.Size2;
		bool flag;
		switch (MacroToCadConverterBase.GetOrientation(lance.Orientation, worldMatrix))
		{
		...
		global::WiCAM.Pn4000.BendModel.Base.Vector3d v = lance.AnchorPoint;
		worldMatrix.TransformInPlace(ref v);
		int color = (flag ? macro3DConfig.MacroPosColorPn : macro3DConfig.MacroNegColorPn);
		global::WiCAM.Pn4000.BendModel.Base.Vector3d v2 = lance.OrientationX;
		...
		foreach (Face face in lance.Faces)
		{
		...
		db2D.AddText(LanceToCadConverter.GetCadTxt(v, num, size, size2, size3, flag ? "+" : "-"));
		return true;
	}
	...
	public static LanceXml GetXmlElement(Lance lance, global::WiCAM.Pn4000.BendModel.Base.Matrix4d worldMatrix)
	{
		double size = lance.Size0;
		double size2 = lance.Size1;
		_ = lance.Size2;
		global::WiCAM.Pn4000.BendModel.Base.Vector3d v = lance.Orientation;
		worldMatrix.TransformNormalInPlace(ref v);
		bool flag = Math.Round(v.Z, 5) > 0.0;
		global::WiCAM.Pn4000.BendModel.Base.Vector3d v2 = lance.AnchorPoint;
