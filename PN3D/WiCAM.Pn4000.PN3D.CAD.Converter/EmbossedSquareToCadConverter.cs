...
public class EmbossedSquareToCadConverter : MacroToCadConverterBase
{
	private const int ToolType = 13;

	public static bool AddCadGeoElements(EmbossedSquare embossed, global::WiCAM.Pn4000.BendModel.Base.Matrix4d worldMatrix, Cad2DDatabase db2D, IConfigProvider configProvider)
	{
		...
		global::WiCAM.Pn4000.BendModel.Base.Vector3d vector3d2 = normalized * 0.5 * embossed.Width;
		db2D.AddText(EmbossedSquareToCadConverter.GetCadTxt(anchorPoint, macro3DConfig.MacroEmbossedToolSuffix, embossed.Depth, depthSign, embossed.Width, num));
	...
	private static CadTxtText GetCadTxt(global::WiCAM.Pn4000.BendModel.Base.Vector3d middlePoint, string toolSuffix, double depth, string depthSign, double width, double angle)
	{
	...
	public static EmbossedSquareXml GetXmlElement(EmbossedSquare embossed, global::WiCAM.Pn4000.BendModel.Base.Matrix4d worldMatrix)
	{
