...
public class DieGroupToolViewModel : GroupToolViewModel
{
	private DieProfileViewModel _dieProfile;
	...
	public DieProfileViewModel Profile
	{
		get
		{
			return this._dieProfile;
		}
		set
		{
			this._dieProfile = value;
	...
	public DieGroupToolViewModel(DieProfileViewModel dieProfile, BendMachine bendMachine, IDrawToolProfiles drawToolProfiles, double width = 92.0, double height = 93.0)
		: base(width, height)
	{
		this.Profile = dieProfile;
		drawToolProfiles.LoadDiePreview2D(this.Profile.DieProfile, base.ImageProfile, bendMachine, showWorkingHeight: false);
	}
