...
namespace ConsoleControl.WPF
{
    ...
    public partial class ConsoleControl : UserControl
    {
        ...
        void ProcessInterface_OnProcessOutput(object sender, ProcessEventArgs args)
        {
            ...
            WriteOutput(args.Content, Colors.LawnGreen);
        ...
        void richTextBoxConsole_PreviewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.Key == Key.Return)
            {
                ...
                WriteInput(input, Colors.LawnGreen, false);
            }
        }
        ...
        /// </summary>
        public readonly ProcessInterface processInterface = new ProcessInterface();
