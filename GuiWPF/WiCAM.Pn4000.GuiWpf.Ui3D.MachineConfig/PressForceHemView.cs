...
public partial class PressForceHemView : UserControl, IComponentConnector
{
	public PressForceHemView()
	{
		InitializeComponent();
	}
	...
	{
		if (base.DataContext is PressForceHemViewModel pressForceHemViewModel)
		{
			pressForceHemViewModel.DataChanged += UpdateTable;
			UpdateTable();
		}
	}
	...
	private void UpdateTable()
	{
		...
		int num = 0;
		foreach (CrowningColumnViewModel column in pressForceHemViewModel.Columns)
		{
	...
	public void UpdateChart()
	{
		...
		foreach (object selectedItem in Datatable.SelectedItems)
		{
			...
			{
				dataSeries.Add(new DataPoint(pressForceHemViewModel.Columns[num++].Length, num2));
