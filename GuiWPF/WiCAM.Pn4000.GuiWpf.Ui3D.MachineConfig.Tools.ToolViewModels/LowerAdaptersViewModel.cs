...
public class LowerAdaptersViewModel : ProfilesAndPartsViewModel<LowerAdapterViewModel, LowerToolPieceViewModel>
{
    [CompilerGenerated]
    ...
    {
        ImportTools(_003C_bystronicXMLImporter_003EP, _003C_bystronicXMLImporter_003EP.ImportLowerAdapters);
    }));
    ...
    {
        ImportTools(_003C_bystronicXMLImporter_003EP, _003C_bystronicXMLImporter_003EP.ImportLowerHolders);
    }));

    public ICommand DelemXMLCommand => _delemXMLCommand ?? (_delemXMLCommand = new RelayCommand((Action<object>)delegate
    {
        ImportTools(_003C_delemXMLImporter_003EP, _003C_delemXMLImporter_003EP.ImportLowerAdapters);
    }));

    public ICommand LVDXMLCommand => _lvdXMLCommand ?? (_lvdXMLCommand = new RelayCommand((Action<object>)delegate
    {
        ImportTools(_003C_lvdXMLImporter_003EP, _003C_lvdXMLImporter_003EP.ImportLowerHolders);
    }));

    public ICommand RadanMDBCommand => _radanMDBCommand ?? (_radanMDBCommand = new RelayCommand((Action<object>)delegate
    {
        ImportTools(_003C_radanMDBImporter_003EP, _003C_radanMDBImporter_003EP.ImportLowerAdapters);
    }));

    public ICommand RadanXMLCommand => _radanXMLCommand ?? (_radanXMLCommand = new RelayCommand((Action<object>)delegate
    {
        ImportTools(_003C_radanXMLImporter_003EP, _003C_radanXMLImporter_003EP.ImportLowerAdapters);
    }));
    ...
    {
        ImportTools(_003C_trumpfARVImporter_003EP, _003C_trumpfARVImporter_003EP.ImportLowerAdapters);
    }));
    ...
    {
        ImportTools(_003C_trumpfARVImporter_003EP, _003C_trumpfARVImporter_003EP.ImportLowerHolders);
    }));
    ...
    {
        ImportTools(_003C_trumpfMDBImporter_003EP, _003C_trumpfMDBImporter_003EP.ImportLowerAdapters);
    }));
    ...
    {
        ImportTools(_003C_trumpfMDBImporter_003EP, _003C_trumpfMDBImporter_003EP.ImportLowerHolders);
    }));
    ...
    {
        ImportTools(_003C_stepAutomationImporter_003EP, _003C_stepAutomationImporter_003EP.ImportLowerAdapters);
    }));
    ...
    {
        ImportTools(_003C_stepAutomationImporter_003EP, _003C_stepAutomationImporter_003EP.ImportLowerHolders);
    }));
    ...
    public override ObservableCollection<LowerAdapterViewModel> Profiles => base.ToolConfigModel.LowerAdapters;
    ...
    public LowerAdaptersViewModel(IConfigProvider _configProvider, Contracts.Common.ITranslator _translator, IUnitConverter _unitConverter,
        IDrawToolProfiles _drawToolProfiles, IGlobalToolStorage _toolStorage, IModelFactory _modelFactory, 
        BystronicXMLImporter _bystronicXMLImporter, DelemXMLImporter _delemXMLImporter, 
        ...
        StepAutomationImporter _stepAutomationImporter) : base(_configProvider, _translator, _drawToolProfiles, _toolStorage, _modelFactory)
    {
    ...
    public override void DeleteProfile(LowerAdapterViewModel profile)
    {
        base.ToolConfigModel.DeleteLowerAdapter(profile);
    }
    ...
    {
        LowerAdapterViewModel profile = new LowerAdapterViewModel(_003C_unitConverter_003EP, _003C_toolStorage_003EP, base.ToolConfigModel.CreateMultiTool(""));
        AddProfile(profile);
    }
