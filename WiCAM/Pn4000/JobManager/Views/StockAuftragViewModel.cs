...
{
	public class StockAuftragViewModel : WiCAM.Pn4000.JobManager.ViewModelBase
    {
		private int _mpid;
        ...
        public string AuftragsNummer
        {
            ...
            set
            {
                if (value != this._AuftragsNummer)
                {
                    this._AuftragsNummer = value;
                    base.NotifyPropertyChanged("AuftragsNummer");
                }
            }
        }
        ...
        public string KundenName
		{
			...
			set
			{
				if (value != this._KundenName)
				{
					...
					base.NotifyPropertyChanged("KundenName");
				}
			}
		}
		...
		public StockAuftragInfo OriginalAuftrag
		{
			get;
			set;
		}
