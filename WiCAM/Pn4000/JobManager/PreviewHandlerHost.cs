...
namespace WiCAM.Pn4000
{
    ...
    public class PreviewHandlerHost : Control
    {
            ...
            if (guid != Guid.Empty)
            {
                try
                {
                    ...
                    if (mCurrentPreviewHandler is IInitializeWithFile)
                    {
                        ...
                        Console.WriteLine(filename + "withfile");
                    ...
                    else if (mCurrentPreviewHandler is IInitializeWithStream)
                    {
                        if (File.Exists(filename))
                        {
                            ...
                            Console.WriteLine(filename + "  stream");
                        }
                        else
                        {
        ...
        [DllImport("shell32.dll"/*@"C:\Users\sense\Desktop\DXF_Vorschau\pnacadprv64.dll"*/, CharSet = CharSet.Unicode, PreserveSig = false)]
